<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    if ($method == 'order_rekap' || $method == 'order_dropship' || $method == 'order_paid') {
        $config['grocery_crud_default_per_page']    = 1000;
    } else {
    ...
    if ($method == 'order_rekap' || $method == 'order_dropship' || $method == 'order_paid') {
        $config['grocery_crud_paging_options'] = array('10', '100','250','500','All');
    } else {
