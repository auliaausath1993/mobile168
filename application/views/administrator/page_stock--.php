		...
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="row search-stock-wrapper">
						...
						<div class="search-category-wrapper col-sm-4 text-right">
							<form name="form2" id="form2" method="post" action="<?=base_url()?>administrator/main/search_category_session" >
								<input type="text" id="name_category_prod" class="autocomplete_cat input-text col-sm-10" placeholder="Nama Kategori Produk" />
					...
					<p><button type="submit" name="go" class="btn btn-success" >UPDATE STOK</button></p>
					<?=form_close()?>
				</div>
			</div>
		</div>
