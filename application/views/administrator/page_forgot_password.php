      ...
      <div class="row">
        <div class="col-lg-4 col-lg-offset-4 m-t-large" style="margin-top: 50px;">
          ...
          <section class="panel">
            ...
            <form action="<?= base_url('administrator/forgot/check_email_user') ?>" method="post" class="panel-body">
              <div class="block">
                <label class="control-label">Masukan Email</label>
                <input type="email" name="email" class="form-control" placeholder="Alamat email account user anda">
              </div>
