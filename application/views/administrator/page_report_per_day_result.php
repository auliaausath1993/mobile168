					...
					<div class="search_report">
						<div class="heading-report">
							...
							<ul id="submenu-container" class="nav nav-tabs nav-justified" style="margin-bottom: 20px;">
								<li <?php if ($this->uri->segment(3) == 'report_per_day_process') { echo 'class="active"'; } ?>><a href="<?=base_url()?>administrator/main/report_per_day" ><b>Laporan Pesanan Harian</b></a></li>
			...
			<div class="row">
				...
				<div class="col-lg-12">
					<div class="row">
						...
						<div class="col-sm-2">
							<form action="<?=base_url()?>administrator/main/report_per_day_eksport" method="post" target="_new">
								<input class="date-input" type="hidden" name="date" value="<?=$this_date ?>"/>
								<input type="hidden" name="jenis_customer" value="<?=$jenis_customer ?>"/>
