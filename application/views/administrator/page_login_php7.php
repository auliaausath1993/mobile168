      ...
      <div class="row">
        <div class="col-lg-4 col-lg-offset-4 m-t-large" style="margin-top: 50px;">
          ...
          <section class="panel">
            ...
            <form action="<?= base_url('administrator/login/login_process_php7') ?>" method="post" class="panel-body">
              <div class="block">
              ...
              <a href="<?=base_url() ?>administrator/forgot" class="pull-right m-t-mini"><small>Lupa password ?</small></a>
