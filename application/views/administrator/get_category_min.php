		...
		<div class="row">
			<div class="col-lg-12">
				...
				<ul id="submenu-container" class="nav nav-tabs nav-justified" style="margin-bottom: 20px;">
					<li class=""><a href="<?=base_url()?>administrator/main/get_category" ><b>Tambah Harga</b></a></li>
					<li class="active"><a href="<?=base_url()?>administrator/main/get_category_min/" ><b>Kurang Harga</b></a></li>
				</ul>
			</div>
		</div>
		<div class="panel">
			<div class="panel-body">
				...
				<?=form_open('administrator/main/edit_price_process_min');?>
