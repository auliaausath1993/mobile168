    ...
    <div id="report" class="container-fluid">
            	...
            	<div class="search_report">
            		...
            		<div class="heading-report">
		                ...
		                <ul id="submenu-container" class="nav nav-tabs" style="margin-bottom: 20px;">
		                  <li><a href="<?=base_url()?>administrator/main/report_pembayaran_perday" ><b>Laporan Pesanan Harian</b></a></li>
		                  <li <?php if ($this->uri->segment(3) == 'report_pembayaran_permonth_process') { echo 'class="active"'; } ?>><a href="<?=base_url()?>administrator/main/report_pembayaran_permonth" ><b>Laporan Pesanan Bulanan</b></a></li>
		                </ul>
            		...
            		<div class="body-report">
            			...
            			<?=form_open('administrator/main/report_pembayaran_permonth_process') ?>
    	...
    	<div class="row">
    		...
    		<div class="col-lg-12">
    			...
    			<div class="row">
    				<div class="col-sm-1">
	    				<form action="<?=base_url()?>administrator/main/report_pembayaran_permonth_print" method="post" target="_new">
	    			...
	    			<div class="col-sm-2">
	    				<form action="<?=base_url()?>administrator/main/report_pembayaran_permonth_eksport" method="post" target="_new">
				...
				<table id="table-laporan" class="table table-bordered table-striped">
					...
					$total_shipping = $total_shipping + $trans->shipping_fee;
					...
					<tr>
						...
						<td>Rp. <?=numberformat($total_shipping) ?></td>
